...
var bottomsTabs = <BottomNavigationBarItem>[
  BottomNavigationBarItem(
    icon: bottomContainer(
        imagePath: ImageRes.home, color: AppColors.primaryFourElementText),
  ...
  BottomNavigationBarItem(
    icon: bottomContainer(
        imagePath: ImageRes.search, color: AppColors.primaryFourElementText),
    activeIcon: bottomContainer(
  ...
  BottomNavigationBarItem(
    icon: bottomContainer(
        imagePath: ImageRes.play, color: AppColors.primaryFourElementText),
    activeIcon: bottomContainer(
  ...
  BottomNavigationBarItem(
    icon: bottomContainer(
        imagePath: ImageRes.message, color: AppColors.primaryFourElementText),
    activeIcon: bottomContainer(
  ...
  BottomNavigationBarItem(
    icon: bottomContainer(
        imagePath: ImageRes.profile, color: AppColors.primaryFourElementText),
    activeIcon: bottomContainer(
...
Widget appScreens({int index = 0}) {
  List<Widget> screens = [
    ...
    CoursesScreen(),
    const Center(
      child: AppImage(imagePath: ImageRes.play, width: 200, height: 200),
    ),
